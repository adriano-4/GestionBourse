...
<div class="tableau">
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>2323</td>
                <td>OIEHFOIH zeofuhzeuof</td>
                <td>M</td>
                <td>15/03/2000</td>
                <td>ENI</td>
                <td>efzefoih@gmail.com</td>
                <td>L3</td>
                <td class="actions">
                    <button class="btn-edit">
                        <i class="fas fa-edit"></i>
    ...
    <div class="ajouter_div">
        ...
        <div class="input-group">
            ...
            <select id="institution" name="institution" required>
                ...
                <option value="École C">École C</option>
            </select>
        </div>
...
<div id="modifier_div_flou">
    <div class="modifier_div">
        ...
        <div class="input-group">
            <label for="nom_prenom">Nom et Prénom</label>
            <input type="text" id="nom_prenom_mod" name="nom_prenom" required>
        </div>
        ...
        <div class="input-group">
            <label for="date_naissance">Date de Naissance</label>
            <input type="date" id="date_naissance_mod" name="date_naissance" required>
        </div>
        ...
        <div class="input-group">
            <label for="niveau">Niveau</label>
            <select id="niveau_mod" name="niveau" required>
                <option value="">Sélectionner</option>
                <option value="Licence 1">Licence 1</option>
                <option value="Licence 2">Licence 2</option>
                <option value="Licence 3">Licence 3</option>
        ...
        <div class="bouton_ajouter">
            <button class="btn_ann">Annuler</button>
            <button class="btn_mod">Modifier</button>
        </div>
